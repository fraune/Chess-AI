...
from app.config import MAXIMUM_PLIES_PER_GAME, SIMULATION_CONFIGURATIONS
...
def run_simulation_set_v2(configurations: list[Configuration] = SIMULATION_CONFIGURATIONS):
